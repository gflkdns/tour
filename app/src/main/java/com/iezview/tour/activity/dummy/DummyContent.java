...
public class DummyContent {
    ...
    static {
        addItem(new DummyItem(String.valueOf(1), "美国大峡谷-The Grand Canyon", "美国大峡谷是一个举世闻名的自然奇观 " +
                "位于西部亚利桑那州西北部的凯巴布高原上 总面积2724.7平方公里 由于科罗拉多河穿流其中 故又名科罗拉多大峡谷 它是联合国教科文组织选为受保护的天然遗产之一 " +
                "", "http://imgsrc.baidu" +
                ".com/forum/w%3D580/sign=8d2725bbb219ebc4c0787691b227cf79" +
                "/d1f9b31bb051f819720e1994dbb44aed2f73e735.jpg"));
        addItem(new DummyItem(String.valueOf(2), "澳大利亚的大堡礁-Great Barrier Reef", "世界上有一个最大最长的珊瑚礁群 " +
        ...
        addItem(new DummyItem(String.valueOf(3), "美国佛罗里达州-Florida", "佛罗里达风景最亮丽的棕榈海滩是全球著名的旅游天堂之一 " +
        ...
        addItem(new DummyItem(String.valueOf(4), "新西兰的南岛-Sout Island ", "新西兰位于南太平洋 西隔塔斯曼海与澳大利亚相望 " +
        ...
        addItem(new DummyItem(String.valueOf(5), "好望角-Cape Town ", "到南非游览 " +
        ...
        addItem(new DummyItem(String.valueOf(6), "金庙-Golden Temple ", "金庙位于印度边境城市阿姆利则 作为锡克教的圣地 " +
        ...
        addItem(new DummyItem(String.valueOf(7), "拉斯维加斯-Las Vegas ",
        ...
        addItem(new DummyItem(String.valueOf(8), "悉尼-Sydney ", "作为2000年奥运会的主办城市 " +
        ...
        addItem(new DummyItem(String.valueOf(9), "纽约-New York ", "除了帝国大厦和自由女神像 " +
        ...
        addItem(new DummyItem(String.valueOf(10), "印度泰姬陵-Taj Mahal ", "坐落于印度古都阿格的泰姬陵 是世界七大奇迹之一 " +
